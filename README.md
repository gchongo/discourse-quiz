...
- Home category list sizes to content height; quiz panel height adapts to content with a viewport-based max-height (no fixed `40vh` category box or full-screen docked height)
